...
export const DirectChat: React.FC<DirectChatProps> = ({ userEmail, isAdmin, adminEmail, initialTarget, onBack }) => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] gap-0 lg:gap-4 max-w-6xl mx-auto overflow-hidden">
      
      {/* Intro Instruction */}
      <div className="glass-panel p-4 rounded-2xl border-white/10 bg-white/5 mb-4 hidden lg:block">
        <div className="flex gap-4 items-center">
          ...
          <div>
            <h4 className="text-[10px] font-black uppercase tracking-widest text-white mb-0.5">Messaging Hub</h4>
            <p className="text-[11px] text-slate-400 leading-relaxed font-bold">
              Butuh bantuan Admin atau ingin mengobrol dengan sesama member? Gunakan fitur ini untuk bertukar pesan secara privat dan aman. Pilih nama di daftar kiri untuk mulai berdiskusi.
            </p>
          </div>
        </div>
      </div>

      <div className="flex flex-1 overflow-hidden gap-0 lg:gap-4">
