      ...
      <AnimatePresence mode="wait">
        {step === 'input' && (
          ...
          >
            ...
            <div>
              <h2 className="text-4xl font-display font-black tracking-tighter mb-2 uppercase italic text-gradient">Automation <span className="text-cyan-500">Hub</span></h2>
